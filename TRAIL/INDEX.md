...
*Last rebuilt: 2026-04-22T08:35:10+02:00*
...
Rationale: *not recorded*
Alternatives: *not recorded*
### DEC-089: Methodology: **Kaizen**. Hardening of an existing mechanism, not redesign.
...
### DEC-090: DEC-001: Treat the live SCORECARD stub as reset bookkeeping, not as a new rub...
...
### DEC-091: DEC-002: Classify the Run 89 re-derivation as `convergent (no addition)` and ...
...
### DEC-092: DEC-001: Treat this GPT-in-thread session as handoff preparation only, not as...
...
### DEC-093: Derive the measurement scheme from the Manifesto before reading the live scor...
...
### DEC-094: Record the Run 90 consolidation outcome as `convergent (no addition)`.
...
### DEC-095: Re-score the current suite state as D1=10, D2=8, D3=9, D4=9, D5=8, D6=7 (mean...
...
### DEC-096: DEC-001: SCORECARD reset on TPS skill suite only; manifesto SCORECARD untouch...
...
Alternatives: *not recorded*
### DEC-097: DEC-002: Move full pre-reset content (rubric definitions + Provenance + Run L...
...
Rationale: *not recorded*
Alternatives: *not recorded*
### DEC-098: DEC-003: Version bump is patch (v2.11.0 → v2.11.1).
...
Alternatives: *not recorded*
### DEC-099: Probe target: Intent skill, claim "the divergence between literal prompt and ...
