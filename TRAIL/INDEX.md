...
*Last rebuilt: 2026-04-20T10:33:35+02:00*
...
### DEC-029: Fix all 4 consistency gaps as Kaizen — no structural change needed
...
### DEC-030: Make target-repo routing explicit in the global VS Code instruction, `kata/SK...
...
### DEC-031: Migrate the skills suite's live run ledger from repo root `GENBA.md` to `TRAI...
...
### DEC-032: Update `verify-suite.ps1` and `metrics.ps1` to use `TRAIL/GENBA.md` as the li...
...
### DEC-033: Move GENBA.md ownership from kiroku to Kata
