...
*Last rebuilt: 2026-04-20T11:37:31+02:00*
...
### DEC-033: Make all measurements context-derived, not universal
...
### DEC-034: Agent inherits prior run's measurement scheme by default
...
### DEC-035: ` matching to line start (`^\s*\[!DECISION\]`) in both kiroku-index.ps1 and k...
