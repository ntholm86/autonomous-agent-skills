...
*Last rebuilt: 2026-04-21T16:50:27+02:00*
...
### DEC-062: Scope limited to PRINCIPLES.md P3 + kata/SKILL.md Step 1 + kata Convergence s...
...
Rationale: *not recorded*
Alternatives: *not recorded*
### DEC-063: Prioritize two script changes only: start-time overlap prevention and validat...
...
### DEC-064: Replace low-signal historical warning noise with checks that detect silent ga...
...
### DEC-065: Stop after current change set.
...
### DEC-066: Vote silence. Examined all 5 skills + kiroku + PRINCIPLES + README + CHANGELO...
...
### DEC-067: Add SCORECARD row for Run 70. Root cause: Run 70 executor labeled run "non-sc...
...
### DEC-068: Fix Metric 7 rather than declare silence. The DRIFT warning is a concrete mec...
...
### DEC-071: Recommend a canonical step spine for all runs, with mandatory per-step output...
...
### DEC-072: Keep this record as reconstructed evidence and close it explicitly rather tha...
...
### DEC-073: Declare silence. Examined all 5 skills and all supporting documents across 8 ...
...
### DEC-074: Selected Kaizen's Challenge Blind Spots claim as the probe target because: (1...
