...
*Last rebuilt: 2026-04-20T10:58:52+02:00*
...
### DEC-027: Fix all 4 consistency gaps as Kaizen — no structural change needed
...
### DEC-028: Make target-repo routing explicit in the global VS Code instruction, `kata/SK...
...
### DEC-029: Migrate the skills suite's live run ledger from repo root `GENBA.md` to `TRAI...
...
### DEC-030: Update `verify-suite.ps1` and `metrics.ps1` to use `TRAIL/GENBA.md` as the li...
...
### DEC-031: Move GENBA.md ownership from kiroku to Kata
...
### DEC-032: ` matching to line start (`^\s*\[!DECISION\]`) in both kiroku-index.ps1 and k...
